...
relaxed & upc\_blocksizeof &
\xreplacedncb[id=GF]{55}
{UPC\_MAX\_BLOCK\_SIZE}{UPC\_MAX\_BLOCKSIZE} \\
...
\begin{changebar}
\begin{em}
Test: This change was made:
\xreplaced[id=GF]{55}
{UPC\_MAX\_BLOCK\_SIZE}{UPC\_MAX\_BLOCKSIZE}.
Note that this change notice has a change bar,
and a foot note, but the actual change to the table
above does not, because changebars and footnotes don't
work from within tables, captions, section headers and
so on.
\end{em}
\end{changebar}
